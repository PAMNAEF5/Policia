...
AddEventHandler('AnnouncePoliceOuvert', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], '~r~Commandant de la Guardia Civil', '~b~Guardia Civil', '~r~CODE ROUGE nous invitons chaques citoyens à regagner son domicile. Controles renforcés !', 'CHAR_ANDREAS', 8)
	end
end)
...
AddEventHandler('AnnouncePoliceAnnonce1', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], '~r~Commandant de la Guardia Civil', '~b~Guardia Civil', '~g~Code vert soyez sans craintes', 'CHAR_ANDREAS', 8)
	end
end)
...
AddEventHandler('AnnouncePoliceAnnonce2', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], '~r~Commandant de la Guardia Civil', '~b~Guardia Civil', '~o~Code orange le taux de criminalité augmente soyez sur vos gardes', 'CHAR_ANDREAS', 8)
	end
end)
